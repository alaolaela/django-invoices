...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'VatInvoice'
        db.create_table('invoices_vatinvoice', (
            ('invoice_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['invoices.Invoice'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('invoices', ['VatInvoice'])


    def backwards(self, orm):
        
        # Deleting model 'VatInvoice'
        db.delete_table('invoices_vatinvoice')
    ...
    models = {
        ...
        'invoices.vatinvoice': {
            'Meta': {'object_name': 'VatInvoice', '_ormbases': ['invoices.Invoice']},
            'invoice_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['invoices.Invoice']", 'unique': 'True', 'primary_key': 'True'})
        }
    }
